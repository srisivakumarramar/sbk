...
# Streamlit UI
st.markdown("<h7 style='text-align: center;font-weight: bold;background-color:DodgerBlue;'>Turn Any Website into Actionable Data – Extract Links & Generate Word Clouds with Ease</h7>", unsafe_allow_html=True)
