...
# Streamlit UI
st.markdown("<h5 style='text-align: center;font-weight: bold;color:Tomato,background-color:DodgerBlue;'>Extract All Links in a Click – Streamlit Cloud Makes It Effortless!</h5>", unsafe_allow_html=True)
